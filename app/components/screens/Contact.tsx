...
const Contact: FC = () => {
  ...
  return (
    <section className="py-8" id="contact">
      <div className="max-w-7xl mx-auto p-6 bg-neutral-950 rounded-lg shadow-md flex flex-wrap">
        <div className="w-full lg:w-1/2 p-6 text-white">
          <h2 className="text-2xl text-justify font-bold mb-4 text-indigo-600">Our Office Address</h2>
          <p className="text-justify">Little Flower, Edava, Thiruvananthapuram, Kerala 695311</p>
          <h2 className="text-2xl text-justify font-bold mt-6 mb-4 text-indigo-600">General Enquiries</h2>
          <p className="text-justify">edavalittleflower@gmail.com</p>
          <h2 className="text-2xl text-justify font-bold mt-6 mb-4 text-indigo-600">Call Us</h2>
          ...
          <h2 className="text-2xl text-justify font-bold mt-6 mb-4 text-indigo-600">Our Timing</h2>
        ...
        <div className="w-full lg:w-1/2 p-6">
          <h1 className="text-3xl text-indigo-600 text-center font-bold mb-6">
            Contact Us
          </h1>
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-center">
              <button
                type="submit"
                className="w-40 bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-teal-700 transition duration-300"
              >
                Submit
              </button>
            </div>
